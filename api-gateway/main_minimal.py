...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Démarrage du backend Agentic Communications V1...")
    print("📍 Backend disponible sur: http://localhost:8000")
    print("📊 Dashboard stats: http://localhost:8000/api/v1/dashboard/stats")
    print("💬 Test chat: curl -X POST http://localhost:8000/api/v1/chat -H 'Content-Type: application/json' -d '{\"message\":\"Bonjour\"}'")
